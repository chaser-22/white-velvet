...
export default function ContactPage() {
  return (
    <>
      ...
      <section className="section"><div className="container contact-grid"><article><span>TELEFON</span><a href="tel:+46739140145">073-914 01 45</a><p>Telefontider: [läggs till]</p></article><article><span>E-POST</span><a href="mailto:info@white-velvet.com">info@white-velvet.com</a><p>Svarstid: [läggs till]</p></article><article><span>ADRESS</span><strong>Ankargatan 27</strong><p>Västerås</p></article></div><div className="contact-banner"><div><span className="eyebrow eyebrow-light">SNABBARE BEDÖMNING</span><h2>Beskriv uppdraget i formuläret.</h2></div><Link className="button button-light" href="/boka">Starta förfrågan</Link></div></section>
    </>
  );
}
