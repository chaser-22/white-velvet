...
export const metadata: Metadata = { title: "Före & efter", description: "Se resultat från White Velvets arbete med textilier, mattor och golv." };
...
export default function ResultsPage() {
  ...
  return (
    <>
      ...
      <section className="section"><div className="container results-grid results-grid-full">{captions.map((caption, index) => <BeforeAfterCard key={caption} index={index + 1} caption={caption} />)}</div></section>
      <CtaBand />
    </>
  );
}
